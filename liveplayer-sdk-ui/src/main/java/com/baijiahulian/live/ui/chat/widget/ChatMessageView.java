package com.baijiahulian.live.ui.chat.widget;
...
public class ChatMessageView extends LinearLayout {
    ...
    private void showMenu(int x, int y) {
        ...
        if (isEnableTranslation && !isTranslate) {
            ...
            popupWindow.setHeight(DisplayUtils.dip2px(getContext(), 112));
        } else {
            ITEMS = new String[]{"复制"};
            popupWindow.setHeight(DisplayUtils.dip2px(getContext(), 72));
        }
        ...
        listView.setPadding(0, DisplayUtils.dip2px(getContext(), 16), 0, DisplayUtils.dip2px(getContext(), 16));
